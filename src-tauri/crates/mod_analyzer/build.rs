    ...
    transmission::compile_proto_fine_grained(
        ...
        &[
            ...
            (
                ...
                "#[serde(alias = \"@modversion\", alias = \"modVersion\")]",
            ),
            (
            ...
            (
                "mods.BarotraumaMod.gameVersion",
                "#[serde(alias = \"@gameversion\", alias = \"gameVersion\")]",
            ),
            (
                "mods.BarotraumaMod.expectedHash",
                "#[serde(alias = \"@expectedhash\", alias = \"expectedHash\")]",
            ),
        ],
    )
}
